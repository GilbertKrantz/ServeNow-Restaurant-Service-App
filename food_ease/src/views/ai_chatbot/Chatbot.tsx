...
function Chatbot() {
  ...
  return (
    <div className="w-full mx-auto h-full bg-[#FFF7D1]">
      ...
      {/* Body */}
      <div className="bg-white h-screen rounded-t-[2.5rem] flex flex-col justify-between">
        {/* Chat Messages */}
        <div className="flex flex-col p-[10%] overflow-y-auto h-[75%]">
          {messages.length === 0 ? (
            ...
            messages.map((message, index) => (
              ...
              >
                <div
                  className={`relative py-2 px-4 max-w-[70%] rounded-lg ${
                    index % 2 === 0
                ...
                >
                  ...
                  <div
                    className={`text-xs mt-1 ${
                      index % 2 === 0 ? "text-gray-400" : "text-white font-light"
                    }`}
                  >
                    {message.time}
                  </div>
